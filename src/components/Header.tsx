      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">ECE Department</h1>
              <p className="text-xs text-muted-foreground hidden sm:block">Electronics & Computer Engineering</p>
            </div>
          </Link>
